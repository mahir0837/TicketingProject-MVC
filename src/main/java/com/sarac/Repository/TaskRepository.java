...
public interface TaskRepository extends JpaRepository<Task,Long> {
    ...
    List<Task> findAllByTaskStatusIsNotAndAssignedEmployee(Status status, User convertToEntity);

    List<Task> findAllByTaskStatusAndAssignedEmployee(Status status, User convertToEntity);
